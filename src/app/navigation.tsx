...
export function SideMenu({ open, onClose, onBuyNow, onOpenGiftSet, user, onLogin, onProfileSettings, onSignOut }: { open: boolean; onClose: () => void; onBuyNow: () => void; onOpenGiftSet: () => void; user: { name: string; email: string } | null; onLogin: () => void; onProfileSettings: () => void; onSignOut: () => void }) {
