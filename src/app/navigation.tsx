...
export function SideMenu({ open, onClose, onBuyNow, onOpenGiftSet, onOpenCollection = () => {}, user, onLogin, onProfileSettings, onSignOut }: { open: boolean; onClose: () => void; onBuyNow: () => void; onOpenGiftSet: () => void; onOpenCollection?: () => void; user: { name: string; email: string } | null; onLogin: () => void; onProfileSettings: () => void; onSignOut: () => void }) {
